function Company(id, name, employeesAmount, location, officialSite, timeOfRegistration = moment().format('LLLL'),
                 balance = 1000000) {
    this.id = id;
    this.name = name;
...
Company.prototype.createAdditionalInfo = function(wrapper) {
    const {location, officialSite, employeesAmount, balance, cars, timeOfRegistration} = this;
    ...
    wrapper.html(`
        <ul class="company-additional-info">
            ...
            <li><span class="important">Time of registration: </span>${timeOfRegistration}</li>
