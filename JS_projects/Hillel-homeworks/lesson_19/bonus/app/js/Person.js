function Person(id, name, age, location, email, timeOfRegistration = moment().format('LLLL'), balance = 100000) {
    this.id = id;
    this.name = name;
...
Person.prototype.createAdditionalInfo = function(wrapper) {
    const {age, location, email, cars, balance, timeOfRegistration} = this;
